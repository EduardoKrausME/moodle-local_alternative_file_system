...
$string['migrate_total'] =
    '<p>You have <strong>{$a->missing}</strong> local files awaiting migration, while <strong>{$a->sending}</strong> files have already been migrated to the remote environment.</p>';
...
$string['settings_migrate'] =
    'Use the service <a target="_blank" href="{$a->url}">move-to-external.php</a> to migrate local data to {$a->local}.';
...
$string['task_movefromobjectfs'] = 'Migrate objects from tool_objectfs to Alternative File System';
